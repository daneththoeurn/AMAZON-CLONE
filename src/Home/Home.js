    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            id="49538094"
            title="Kenwoood kMix Stand Mixer for Baking, Stylish Kitchen Mixer with K-beater, Dough Hook and Whisk, 5 Litre Glass Bowl"
            price={239.0}
            rating={4}
        ...
        <div className="home__row">
          <Product
            id="90829332"
            title="Samsung LC49RG60SSUXEN 49' Curved LED Gaming Monitor - Super Ultra Wide Dual WQHD 5120 x 1440"
            price={1094.98}
            rating={4}
